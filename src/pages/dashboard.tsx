...
import { taskStatusColor, taskStatusLabel } from "@/lib/task-status";
...
export default function Dashboard() {
  ...
  const getStatusColor = (status: string) => taskStatusColor(status);

  const getStatusLabel = (status: string) => taskStatusLabel(status);
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="em_revisao">Aguardando validação</SelectItem>
